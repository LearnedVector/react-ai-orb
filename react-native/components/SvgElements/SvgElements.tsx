...
export const SvgElements = ({ color1, color2 }: SvgElementsProps) => (
  <>
    <Svg viewBox="0 0 100 100" width="100%" height="100%" style={{ position: 'absolute', opacity: 0.3 }}>
      <Defs>
    ...
    <Svg viewBox="0 0 100 100" width="100%" height="100%" style={{ position: 'absolute', opacity: 0.9 }}>
      <Defs>
